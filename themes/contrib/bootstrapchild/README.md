...
first `bootstrap` directory (e.g. `./bootstrapchild/bootstrap/bootstrap`), remove the
wrapping `bootstrap` directory. You will only ever need to touch these files if
or when you upgrade your version of the [Bootstrap Framework].

{.alert.alert-warning} **WARNING:** Do not modify the files inside of
`./bootstrapchild/bootstrap` directly. Doing so may cause issues when upgrading the
[Bootstrap Framework] in the future.

## Overrides {#overrides}
The `./bootstrapchild/scss/_default-variables.scss` file is generally where you will
...
The `./bootstrapchild/scss/overrides.scss` file contains various Drupal overrides to
properly integrate with the [Bootstrap Framework]. It may contain a few
enhancements, feel free to edit this file as you see fit.

The `./bootstrapchild/scss/style.scss` file is the glue that combines:
...
that you should compile to `./bootstrapchild/css/style.css` (note the same file
